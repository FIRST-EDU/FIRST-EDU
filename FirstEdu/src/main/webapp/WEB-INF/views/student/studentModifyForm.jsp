...
<meta charset="UTF-8">
	...
	<title> 원생 관리 &gt; 원생 정보 수정 | FIRST EDU</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-4 col-md-6">
            <form action="${ pageContext.servletContext.contextPath }/student/modify" method="post" class="common-card teacher-input-card">
              <section class="teacher-input-box">
              <input type="hidden" name="no" value="${ student.no }">
                <article class="teacher-input-form">
                  <label class="essential">* 학생명</label>
                  <div class="input-group">
                    <input id="studentName" name="studentName" class="form-input" type="text" autocomplete="new-password" value="${ student.studentName }" required/>
                  </div>
                </article>
                ...
                <article class="teacher-input-form">
                  ...
                  <div class="input-group">
                    <input id="school" name="school" class="form-input" type="text" autocomplete="new-password" value=${ student.school } required/>
                  </div>
                </article>
                ...
                <article class="teacher-input-form">
                  ...
                  <select id="gradeCode" name="gradeCode" class="form-select" required>
                    <option>선택</option>
                    <c:if test="${ student.grade.code eq 'H1'}">
	                    <option value="H1" selected>고1</option>
                    </c:if>
                    <c:if test="${ student.grade.code ne 'H1'}">
	                    <option value="H1">고1</option>
                    </c:if>
                    <c:if test="${ student.grade.code eq 'H2'}">
	                    <option value="H2" selected>고2</option>
                    </c:if>
                    <c:if test="${ student.grade.code ne 'H2'}">
	                    <option value="H2">고2</option>
                    </c:if>
                    <c:if test="${ student.grade.code eq 'H3'}">
	                    <option value="H3" selected>고3</option>
                    </c:if>
                    <c:if test="${ student.grade.code ne 'H3'}">
                ...
                <article class="teacher-input-form">
                  ...
                  <div class="input-group">
                    <input id="studentPhone" name="studentPhone" class="form-input" type="text" autocomplete="new-password" value="${ student.studentPhone }" required/>
                  </div>
                </article>
                ...
                <article class="teacher-input-form">
                  ...
                  <div class="input-group">
                    <input id="parentsName" name="parentsName" class="form-input" type="text" autocomplete="new-password" value="${ student.parentsName }" required/>
                  </div>
                </article>
                ...
                <article class="teacher-input-form">
                  ...
                  <div class="input-group">
                    <input id="parentsPhone" name="parentsPhone" class="form-input" type="text" autocomplete="new-password" value="${ student.parentsPhone }" required/>
                  </div>
                </article>
                ...
                <article class="teacher-input-form">
                  ...
                  <div class="checkbox-wrap">
                      ...
                      value="1"
                      />
                      <label for="female" class="check-discount check-female checked-radio">
                      ...
                      <input
                        ...
                        checked
                      />
                      <label for="male" class="check-discount check-male checked-radio">
                        <i class="fas fa-check"></i>
                      </label>
                      <label for="male" class="discount chack-male">남자</label>
                  	</c:if>
                ...
                <article class="teacher-input-form">
                  <div class="date-align">
                    <label>생년월일</label>
                    <input class="attendance-date" id="birth" type="date" name="birth" value="${ student.birth }">
                ...
                <article class="teacher-input-form">
                  <label>주소</label>
                  <div class="input-group">
                    <input id="basicAddress" name="basicAddress" class="form-input" type="text" value="${ fn: substring( student.address, 0, fn:indexOf(student.address, '$') ) }" readonly/>
                  </div>
                ...
                <article class="teacher-input-form">
                  <label>상세주소</label>
                  <div class="input-group">
                    <input id="detailAddress" name="detailAddress" class="form-input" type="text" value="${ fn: substring( student.address, fn:indexOf(student.address, '$')+1, fn:length(student.address) ) }" autocomplete="new-password"/>
                  </div>
                </article>
                  ...
                  <c:forEach var="classInfo" items="${ student.classList }">
                  	<c:if test="${ classInfo.subjectNo eq '1' }">
                  		<span id="classSpan" class="tag-light-blue">
                  			...
                  			&nbsp; &nbsp;
                  			<span id="removeBtn" onclick="removeClass(this)">&#215;</span>
                  		</span>
                  	</c:if>
...
<script src="${ pageContext.servletContext.contextPath }/resources/js/student/studentModifyForm.js"></script>
