  ...
  <div class="modal detail-board-modal" id="consultModal">
    <div class="modal-content">
      <section class="form-left">
        ...
        <label>상담번호</label>
        <div class="input-group">
          <input class="form-input" type="text" id="consultNo" name="consultNo" value="consultNo" readonly />
        </div>
        </article>
        ...
        <button type="button" class="btn-fill-primary btn-basic"
        onclick="location.href='${pageContext.servletContext.contextPath}/pay/update'">수정</button>
      </div>
    </div>
  </div>
