			...
			<div class="row">
				<div class="col-sm-4 col-md-6">
					<form class="common-card class-detail-card"
						action="${ pageContext.servletContext.contextPath }/classInfo/classUpdate"
						method="post">
						<section class="class-input-box">
							<article class="teacher-input-form">
								<label>강의번호</label>
								<div class="input-group">
									<input class="form-input" id="classNum" name="classNum"
										value="${ classUpdate.classNum}" />
								</div>
							</article>
							...
							<article class="teacher-input-form">
								<label>강의실</label>
								<div class="input-group">
									<input class="form-input" id="room" name="room"
										value="${ classUpdate.room}" />
								</div>
							</article>
							...
							<article class="teacher-input-form">
								<label>강의명</label>
								<div class="input-group">
									<input class="form-input" name="className"
										value="${ classUpdate.className}" />
								</div>
							</article>
							...
							<article class="teacher-input-form">
								<label>교재</label>
								<div class="input-group">
									<input class="form-input" name="book"
										value="${ classUpdate.book}" />
								</div>
							</article>
							...
							<article class="teacher-input-form">
								<label>수강료</label>
								<div class="input-group">
									<input class="form-input" name="payment"
										value="${ classUpdate.payment}" />
								</div>
							</article>
