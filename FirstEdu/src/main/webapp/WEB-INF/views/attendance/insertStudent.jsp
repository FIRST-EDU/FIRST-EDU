...
<input type="checkbox" name="categoryNo1" id="dis1" value="1" >출석
<input type="checkbox" name="categoryNo1" id="dis2" value="2">결석
<input type="checkbox" name="categoryNo1" id="dis3" value="3">지각
<input type="checkbox" name="categoryNo1" id="dis4" value="4">조퇴
