				...
				<div class="col-sm-4">
					<section class="common-table-card consult-table-card">
						<table align="center" id="classListArea"
							class="common-table consult-table">
							<tr >
								<td>번호</td>
							...
							<tr>
								<td>직급코드</td>
								<td><c:out value="${memberDetail.jobCode}" /></td>
							</tr>
							<tr>
								<td>이름</td>
							...
							<tr>
								<td>주소</td>
								<td><c:out value="${memberDetail.address}" /></td>
							<tr>
								<td>권한</td>
								<td><c:out value="${memberDetail.role}" /></td>
							</tr>
							<tr>
								<td>입사일</td>
							...
							<tr>
								<td>퇴사일</td>
								<td><c:out value="${memberDetail.endDate}" /></td>
							</tr>
							<tr>
								<td>근무여부</td>
								<td><c:out value="${memberDetail.status}" /></td>
							</tr>
						</table>
						<br>

						<div align="center">
							<button id="updateBtn" onclick="location.href='${ pageContext.servletContext.contextPath}/member/update'">수정</button>
		...
		$("#updateBtn")
				.click(
						function() {
							...
							const no = $("#no").val();
							console.log(no);
							location.href = "${pageContext.servletContext.contextPath}/member/update/"
									+ parseInt(no);
						})
	</script>
